...
var app = angular.module('gpxRide', ['angularFileUpload']).
  ...
  $routeProvider.
      ...
      when('/ride/:rideId', {templateUrl: 'partials/ride-detail.html', controller: 'viewRideController'}).
      when('/', {templateUrl: 'partials/home.html', controller: 'welcomeController'}).
...
var renderingOptions = [
						["Circle",circleInfographic],
						["Basic",basicPlot],
						["Extruded",extrudedPlot],
						["Rendered",renderedPlot],
						["Mountains",mountainPlot],
						["Wavey",waveyPlot]
					]
